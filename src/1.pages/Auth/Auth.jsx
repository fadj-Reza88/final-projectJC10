            ...
            <div className="container auth">
                ...
                <div className="row">
                    <div className="col-3 text-center auth-left">
                        <h3>Welcome!</h3>
                        <p>Belanja Elektronik yang aman hanya di Ruang Elektronik, mari bergabung bersama kami!</p>
                        <br/>
                        <br/>
                    ...
                    <div className="col-9 auth-right text-center pb-5">
                        {
                            ...
                            <div className="container-fluid">
                                <h3 className="pb-3" style={{color : '#495057', marginTop:'8%'}}>Daftar Sekarang!</h3>
                                <div className="row">
                                    <div className="col-6">
                            ...
                            :
                            <div className="container-fluid">
                                <h3 className="pb-3" style={{color : '#495057', marginTop:'8%'}}>Masuk Sekarang!</h3>
                                <div className="row">
                                    <div className="col-6">
                                        <div className="form-group">
